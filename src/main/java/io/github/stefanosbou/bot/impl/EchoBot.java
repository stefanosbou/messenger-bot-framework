...
import io.github.stefanosbou.model.threadSettings.ThreadSettings;
...
public class EchoBot extends MessengerBot{
	...
	protected String setGreetingText() {
		ThreadSettings greet = ThreadSettings.builder().addGreetingText("Hello!").build();
		return Utils.objectToJson(greet);
	}

	@Override
	protected String setGetStartedButton() {
		ThreadSettings greet = ThreadSettings.builder()
									.addGetStartedButton("GETSTARTED")
									.build();
